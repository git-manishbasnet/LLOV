...
const App = () => {
  ...
  const calculateLove = async () => {
    ...
    try {
       const response = await axios.post("https://love-calculator-two-brown.vercel.app/api/entries", newEntry);
      ...
      // Fetch the updated entries after saving the new entry
       const entriesResponse = await axios.get("https://love-calculator-two-brown.vercel.app/api/entries");
