...
const App = () => {
  ...
  const calculateLove = async () => {
    ...
    try {
      const response = await axios.post("https://love-calculator-murex.vercel.app/api/entries", newEntry);
      console.log("Backend response:", response.data);

      // Fetch the updated entries after saving the new entry
      const entriesResponse = await axios.get("https://love-calculator-murex.vercel.app/api/entries");
